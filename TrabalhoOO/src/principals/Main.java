...
public class Main {
	private static LinkedList<Republica> criarRepublica(LinkedList<Republica> rep) {
		String nomeRep=JOptionPane.showInputDialog(null, "Por favor, insira o nome da nova república", "Nova república", 0);
	...
	public static void main(String[] args) {
		...
		while(isOpen==true) {
			...
			escolhaRep=JOptionPane.showOptionDialog(null, "Bem vindo ao Gerenciador Financeiro para repúblicas\n\n Crie, delete ou escolha uma república que deseja editar", "Gerenciador Financeiro - Seletor de República", 0, 0, null, optMenu, null);
